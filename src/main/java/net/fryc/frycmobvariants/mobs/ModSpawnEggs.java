...
public class ModSpawnEggs {
    ...
    public static void registerSpawnEggs(){
        ...
        Registry.register(Registry.ITEM, new Identifier(MobVariants.MOD_ID, "frozen_zombie_spawn_egg"), FROZEN_ZOMBIE_SPAWN_EGG);
        Registry.register(Registry.ITEM, new Identifier(MobVariants.MOD_ID, "tropical_spider_spawn_egg"), TROPICAL_SPIDER_SPAWN_EGG);
        Registry.register(Registry.ITEM, new Identifier(MobVariants.MOD_ID, "corsair_spawn_egg"), CORSAIR_SPAWN_EGG);
        ...
        Registry.register(Registry.ITEM, new Identifier(MobVariants.MOD_ID, "infected_piglin_spawn_egg"), INFECTED_PIGLIN_SPAWN_EGG);
        Registry.register(Registry.ITEM, new Identifier(MobVariants.MOD_ID, "infected_piglin_brute_spawn_egg"), INFECTED_PIGLIN_BRUTE_SPAWN_EGG);
        Registry.register(Registry.ITEM, new Identifier(MobVariants.MOD_ID, "soul_stealer_spawn_egg"), SOUL_STEALER_SPAWN_EGG);
